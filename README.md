...
For detailed instructions on building and running the project, see the [Usage Guide](USAGE.md).
...
New to Git? Check out our [Git Commit Guide](GIT_GUIDE.md) to learn how to write proper commits and work with the team!
